                                        ...
                                        if(n / modpow(10, 12) >= 10){
                                            ...
                                            if(n / modpow(10, 13) >= 10){
                                                ...
                                                if(n / modpow(10, 14) >= 10){
                                                    ...
                                                    }else ans += (n - modpow(10, 15)+1)*5;
                                                }else ans += (n - modpow(10, 14)+1)*4;
                                            }else ans += (n - modpow(10, 13)+1)*4;
                                        }else ans += (n - modpow(10, 12)+1)*4;
                                    }else ans += (n - modpow(10, 11)+1)*3;
                                }else ans += (n - modpow(10, 10)+1)*3;
                            }else ans += (n - modpow(10, 9)+1)*3;
                        }else ans += (n - modpow(10, 8)+1)*2;
                    }else ans += (n - modpow(10, 7)+1)*2;
                }else ans += (n - modpow(10, 6)+1)*2;
            }else ans += (n - modpow(10, 5)+1);
        }else ans += (n - modpow(10, 4)+1);
    }else if(n / modpow(10, 3) < 10 && n / modpow(10, 3) >= 1){ // 1000以上
        ans += (n - modpow(10, 3)+1);
    }
    cout << ans << endl;
}